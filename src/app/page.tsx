	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
			...
			<main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
				...
				{/* Success Message with Go to Dashboard */}
				{submitSuccess && (
					<div className="mb-6 p-6 rounded-2xl text-center" style={{ backgroundColor: '#f2f9e8', border: '2px solid #44795c' }}>
						<div className="text-4xl mb-3">&#10003;</div>
						<h3 className="text-2xl font-bold mb-2" style={{ color: '#14332d' }}>
							Your business idea has been submitted!
						</h3>
						<p className="mb-6" style={{ color: '#44795c' }}>
							Head to your dashboard to see your personalized business roadmap.
						</p>
						<Link
							href="/dashboard"
							className="inline-block px-8 py-3 rounded-xl font-semibold text-white text-lg transition-all duration-200 hover:opacity-90"
